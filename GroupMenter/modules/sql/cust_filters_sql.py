...
from sqlalchemy import Column, String, UnicodeText, Boolean, Bigint, distinct, func
...
class CustomFilters(BASE):
    ...
    # alter table cust_filters add column file_type BigInt default 1;
    # alter table cust_filters add column file_id text;
    reply_text = Column(UnicodeText)
    file_type = Column(BigInt, nullable=False, default=1)

...
from sqlalchemy import BigInt, Boolean, Column, BigInt, String, UnicodeText
...
class Welcome(BASE):
    ...
    welcome_type = Column(BigInt, default=Types.TEXT.value)

    custom_leave = Column(UnicodeText, default=random.choice(DEFAULT_GOODBYE_MESSAGES))
    leave_type = Column(BigInt, default=Types.TEXT.value)

    clean_welcome = Column(BigInt)
